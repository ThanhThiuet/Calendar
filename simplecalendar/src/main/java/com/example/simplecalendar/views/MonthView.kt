package com.example.simplecalendar.views
...
import com.example.simplecalendar.helpers.LOW_ALPHA
import com.example.simplecalendar.helpers.MEDIUM_ALPHA
import com.example.simplecalendar.models.DayMonthly
import com.example.simplecalendar.models.Event
import com.example.simplecalendar.models.MonthViewEvent
...
class MonthView(context: Context, attrs: AttributeSet, defStyle: Int) : View(context, attrs, defStyle) {
    ...
    private fun initWeekDayLetters() {
        dayLetters = context.resources.getStringArray(R.array.week_day_letters_vietnamese).toMutableList() as ArrayList<String>
