...
abstract class MyRecyclerViewAdapter1(val activity: BaseSimpleActivity1, val recyclerView: MyRecyclerView, val fastScroller: FastScroller? = null,
                                  val itemClick: (Any) -> Unit) : RecyclerView.Adapter<MyRecyclerViewAdapter1.ViewHolder>()
{
